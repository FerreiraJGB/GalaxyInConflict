...
function init()
  ...
  self.statModifierGroup = effect.addStatModifierGroup({
    ...
    {stat = "iceResistance", amount = 0.8},
    {stat = "poisonResistance", amount = 0.8},
    {stat = "electricResistance", amount = 0.8},
    {stat = "physicalResistance", amount = 0.8},
	
    {stat = "ews_meleeResistance", amount = 0.0},
    {stat = "ews_smallarmsResistance", amount = 0.8},
    {stat = "ews_heavyarmsResistance", amount = 0.8},
    {stat = "ews_explosiveResistance", amount = 0.8},	
    {stat = "ews_antitankResistance", amount = 0.8},	
