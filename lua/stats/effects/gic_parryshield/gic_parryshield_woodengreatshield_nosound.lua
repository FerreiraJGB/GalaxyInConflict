...
function init()
  ...
  self.statModifierGroup = effect.addStatModifierGroup({
    ...
    {stat = "ews_smallarmsResistance", amount = 0.4},
    {stat = "ews_heavyarmsResistance", amount = 0.4},
    {stat = "ews_explosiveResistance", amount = 0.4},
    {stat = "ews_antitankResistance", amount = 0.0},	
    {stat = "ews_psychicResistance", amount = 0.4},	
