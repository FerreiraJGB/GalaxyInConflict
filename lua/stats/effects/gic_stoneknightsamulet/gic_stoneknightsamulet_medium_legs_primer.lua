...
local duration = 5
function update()
	if status.stat("gic_armor_weight_medium_legs") == 1 then
		status.addEphemeralEffect("gic_stoneknightsamulet_medium_legs",1); -- this function can config effect duration
