...
local duration = 5
function update()
	if status.stat("gic_smokegrenade_concealment") == 1 then
		status.addEphemeralEffect("gic_advancedmunition_overcharged",20); -- this function can config effect duration
