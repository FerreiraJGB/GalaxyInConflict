...
local duration = 5
function update()
	if status.stat("gic_rally_khurtovyna_redarmy") == 1 then
		status.addEphemeralEffect("gic_npc_death_khurtovyna_redarmy_rapidconscription",30); -- this function can config effect duration
