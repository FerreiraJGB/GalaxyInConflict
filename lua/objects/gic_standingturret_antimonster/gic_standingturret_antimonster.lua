...
function autoFire()
  ...
  while true do
    ...
    world.spawnProjectile("gic_standardbullet_a_machinegun_turret", firePosition(), entity.id(), aimVector, false, projectileParameters)
...
function findTarget()
  ...
  return util.find(nearEntities,  function(entityId)
    ...
    if not entity.entityInSight(entityId) or world.lineTileCollision(self.basePosition, targetPosition) then return false end
