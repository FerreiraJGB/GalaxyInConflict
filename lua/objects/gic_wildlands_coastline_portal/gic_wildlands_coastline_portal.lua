...
--		{
--          name = "Coastline",
--          planetName = "[Beginning of the End]",
--          icon = "default",
--          warpAction = string.format("InstanceWorld:gic_wildlands_coastline:%s:%s", storage.uuid, world.threatLevel())
--        },
		
    {
          name = "Hunter's Island Lodge",
          planetName = "[The Damned]",
          icon = "default",
          warpAction = string.format("InstanceWorld:gic_wildlands_compound_island_bountyhunthub:%s:%s", storage.uuid, world.threatLevel())
    }
