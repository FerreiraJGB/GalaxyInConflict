...
--    status.addEphemeralEffect("gic_spearoftherepentful",10) --Placing this in here will only activate the status effect
    if self.damageDisableTimer == 0 then
   d status.addEphemeralEffect("gic_spearoftherepentful",10)
