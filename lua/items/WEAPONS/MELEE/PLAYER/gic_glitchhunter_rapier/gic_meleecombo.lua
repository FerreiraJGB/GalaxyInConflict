...
function MeleeCombo:fire()
  ...
  if (self.comboStep % 1 == 2) and (not mcontroller.zeroG()) and (not mcontroller.crouching()) and mcontroller.onGround() then mcontroller.setVelocity({mcontroller.facingDirection()*50,1}) end --25,1
