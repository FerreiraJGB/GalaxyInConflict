...
function MeleeCombo:fire()
  ...
  if (self.comboStep % 2 == 1) and (not mcontroller.zeroG()) and (not mcontroller.crouching()) and mcontroller.onGround() then mcontroller.setVelocity({mcontroller.facingDirection()*25,1}) end
