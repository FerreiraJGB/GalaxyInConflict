...
gic_ichimonji = MeleeSlash:new()
function gic_ichimonji:init()
...
function gic_ichimonji:windup(windupProgress)
...
function gic_ichimonji:winddown(windupProgress)
  self.weapon:setStance(self.stances.windup)
...
function gic_ichimonji:setupInterpolation()
...
function gic_ichimonji:bounceWeaponAngle(ratio)
...
function gic_ichimonji:windupAngle(ratio)
