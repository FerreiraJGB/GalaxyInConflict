...
require "/interface/games/gic_bombdefusalgame/generator.lua"
require "/interface/games/gic_bombdefusalgame/tools.lua"
require "/interface/games/gic_bombdefusalgame/tileset.lua"
require "/interface/games/gic_bombdefusalgame/ui.lua"
...
function initGui(tools)
  ...
  self.frame = Sprite:new("/interface/games/gic_bombdefusalgame/images/frame.png", {314, 221})
  self.fossilCounter = Sprite:new("/interface/games/gic_bombdefusalgame/images/fossilcountericon.png", {21, 21}, {1, 1})
  self.treasureIndicator = Sprite:new("/interface/games/gic_bombdefusalgame/treasurechest.png", {16, 16}, {1, 1})
  self.winScreen = Sprite:new("/interface/games/gic_bombdefusalgame/images/winningframe.png", {314, 221})
  self.loseScreen = Sprite:new("/interface/games/gic_bombdefusalgame/images/losingframe.png", {314, 221})
  self.incompleteScreen = Sprite:new("/interface/games/gic_bombdefusalgame/images/incompleteframe.png", {314, 221})
end
...
function drawGui()
  ...
  gameCanvas:drawText("DEFUSAL", {position = {230, 183}, width = 88}, 12)
