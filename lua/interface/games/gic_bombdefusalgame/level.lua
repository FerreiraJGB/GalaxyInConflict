...
require "/interface/games/gic_bombdefusalgame/gic_bombdefusal.lua"

Level = {}

function Level:new(size, tileSize, position, dirt, rock, metallic)
  local newLevel = {
    tileSize = tileSize,
    size = size,
    position = position,
...
function Level:init()
  ...
  self.boneLayer:setMaterialData(self.metallicMaterial)
