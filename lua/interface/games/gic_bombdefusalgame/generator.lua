...
require "/interface/games/gic_bombdefusalgame/level.lua"
...
function LevelGenerator:generate(size, tileSize, position, dirt, rock, metallic, treasure)
  local level, toolUses
  repeat
    toolUses = false
    level = Level:new(size, tileSize, position, dirt, rock, metallic, treasure)
    level:init()
