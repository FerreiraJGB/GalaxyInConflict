...
require "/interface/games/gic_bombdefusalgame/sprite.lua"

Tool = {}
Tool.name = "Tool"
Tool.area = {{0,0}}
Tool.size = {1,1}
Tool.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/brushtool.png", {16,16}, {2,1}, 2)
...
BrushTool.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/brushtool.png", {20,20}, {3,1}, 3)
BrushTool.buttonIcon = "/interface/games/gic_bombdefusalgame/images/brushicon.png"
BrushTool.buttonBackground = "/interface/games/gic_bombdefusalgame/images/fullbutton.png"
BrushTool.sprite.origin = {10,-1}
BrushTool.sprite.scale = 2
BrushTool.sound = "/sfx/armor/gic_bloodborne_body-armor-6.wav"
...
SquareTool.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/hammertool.png", {20,20}, {3,1}, 3)
SquareTool.buttonIcon = "/interface/games/gic_bombdefusalgame/images/squareicon.png"
SquareTool.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
...
CrossTool.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/dynamitetool.png", {20,20}, {3,1}, 3)
CrossTool.buttonIcon = "/interface/games/gic_bombdefusalgame/images/crossicon.png"
CrossTool.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
...
VRect.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/mattockvrect.png", {20,20}, {3,1}, 3)
VRect.buttonIcon = "/interface/games/gic_bombdefusalgame/images/vrecticon.png"
VRect.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
...
HRect.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/mattockhrect.png", {20,20}, {3,1}, 3)
HRect.buttonIcon = "/interface/games/gic_bombdefusalgame/images/hrecticon.png"
HRect.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
...
TLeft.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/drilltooltleft.png", {20,20}, {3,1}, 3)
TLeft.buttonIcon = "/interface/games/gic_bombdefusalgame/images/tlefticon.png"
TLeft.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
TLeft.sprite.origin = {0,0}
TLeft.sprite.scale = 2
TLeft.sound = {"/sfx/tools/pickaxe_hit.ogg"}
...
TRight.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/drilltooltright.png", {20,20}, {3,1}, 3)
TRight.buttonIcon = "/interface/games/gic_bombdefusalgame/images/trighticon.png"
TRight.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
TRight.sprite.origin = {16,0}
TRight.sprite.scale = 2
TRight.sound = {"/sfx/tools/pickaxe_hit.ogg"}
...
Dot.sprite = Sprite:new("/interface/games/gic_bombdefusalgame/images/chiseltool.png", {20,20}, {3,1}, 3)
Dot.buttonIcon = "/interface/games/gic_bombdefusalgame/images/doticon.png"
Dot.buttonBackground = "/interface/games/gic_bombdefusalgame/images/halfbutton.png"
Dot.sprite.origin = {0,0}
Dot.sprite.scale = 2
Dot.sound = {"/sfx/tools/pickaxe_hit.ogg"}
